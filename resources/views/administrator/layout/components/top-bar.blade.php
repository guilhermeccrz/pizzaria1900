            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="{{ route('administrator.user.edit', Auth::user()->id) }}">
                            <i class="ti-user m-r-5 m-l-5"></i> Meu Perfil
                        </a>
                        <a class="dropdown-item" href="{{ route('administrator.auth.logout') }}">
